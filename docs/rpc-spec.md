...
| `trash_can_enabled` | boolean | true means a deleted torrent's files are moved to the trash / recycle bin when possible
...
| `session_get` | new arg `trash_can_enabled`
| `session_set` | new arg `trash_can_enabled`
